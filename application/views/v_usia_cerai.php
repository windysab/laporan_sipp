          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form action="<?php echo base_url()?>index.php/Usia_cerai" method="POST" >
                Laporan Bulan :
              ...
              <div class="card-body">
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tr>
                    ...
                    <th>Tanggal Putus</th>
                    <th>Nama P</th>
                    <th>Tanggal Lahir P</th>
                    <th>Nama T</th>
                    <th>Tanggal Lahir T</th>
                  </tr>
                  </thead>
                  <tbody>
                  <?php 
                  ...
                  <tr>
                    <td><?php echo $no++?></td>
                    <td><?php echo $row->usia_p?> Tahun</td>
                    <td><?php echo $row->usia_t?> Tahun</td>
                    ...
                    <td><?php echo $row->tanggal_lahir_t?></td>
                  </tr>
                  <?php endforeach; ?>
                  </tbody>
                </table>
