  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5>Laporan Perceraian Untuk KUA</h5>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form action="<?php echo base_url()?>index.php/Cerai_kua" method="POST" >
                Laporan Bulan :
              ...
              <div class="card-body">
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tr>
                    ...
                    <td><?php echo $row->alamat_t?></td>
                    <td><?php echo $row->kua_tempat_nikah?></td>
