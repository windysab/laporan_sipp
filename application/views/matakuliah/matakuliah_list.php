        ...
        <div class="col-12" style="margin-top:2px ">
          <div class="card">
            <div class="card-header">
              ...
              <h3 class='box-title'>MATA KULIAH LIST <?php echo anchor('matakuliah/create/','Create',array('class'=>'btn btn-danger btn-sm'));?>
              ...
              <table  class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td style="text-align:center" width="140px">
                    <?php 
                    echo anchor(site_url('matakuliah/read/'.$row->id_mata_kuliah),'<i class="fa fa-eye"></i>',array('title'=>'detail','class'=>'btn btn-primary btn-sm')); 
                    echo '  '; 
                    echo anchor(site_url('matakuliah/update/'.$row->id_mata_kuliah),'<i class="fa fa-edit"></i>',array('title'=>'edit','class'=>'btn btn-warning btn-sm')); 
                    echo '  '; 
                    echo anchor(site_url('matakuliah/delete/'.$row->id_mata_kuliah),'<i class="fa fa-trash"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                    ?>
                  </td>
                </tr>
                <?php
