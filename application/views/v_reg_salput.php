  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5>Register Petikan Salinan Putusan ke KUA</h5>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <form action="<?php echo base_url()?>index.php/Reg_salput" method="POST" >
                Laporan Bulan :
              ...
              <div class="card-body">
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tr>
                    ...
                    <th>TANGGAL PENETAPAN IKRAR TALAK</th>
                    <th>TANGGAL TERJADINYA PERCERAIAN</th>
                  </tr>
                  </thead>
                  <tbody>
                  <?php 
                  ...
                  <tr>
                    ...
                    <td><?php echo $row->pihak1_text?> <br> <?php echo $row->alamat_p?></td>
                    <td><?php echo $row->pihak2_text?> <br> <?php echo $row->alamat_t?></td>
                    <td><?php echo $row->no_kutipan_akta_nikah?></td>
                    <td><?php echo $row->tgl_kutipan_akta_nikah?></td>
