...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template_tabel','menu','menu/menu_list', $data);
    ...
    public function read($id) 
    {
		...
		'is_parent' => $row->is_parent,
            ...
            $this->template->load('template_tabel','menu','menu/menu_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template_form','menu','menu/menu_form', $data);
    }
